...
\begin{tikzpicture}[auto]
  ...
  \node [cloud , ultra thick, node distance=5cm, text width=5cm, fill=lpink!30, font=\Huge, left = 1cm of numerical-principle] (fdm) {finite differences}; 
  \draw[double arrow=7pt colored by black and red] (numerical-principle) -- (fdm);  
  \node [cloud , ultra thick, node distance=5cm, text width=5cm, fill=lpink!30, font=\Huge, right = 1cm of numerical-principle] (csm) {complex \\ step}; 
  ...
  \node [cloud , ultra thick, node distance=5cm, text width=5cm, fill=lgreen!30, font=\Huge, right = 1cm of computational-principle] (adm) {algorithmic \\differentiation}; 
  ...
  \node [cloud , ultra thick, node distance=5cm, text width=5cm, fill=lblue!30, font=\Huge, left = 1cm of analytical-principle] (adjoint) {adjoint \\ method}; 
  \draw[double arrow=7pt colored by black and blue] (analytical-principle) -- (adjoint);  
  \node [cloud , ultra thick, node distance=5cm, text width=5cm, fill=lblue!30, font=\Huge, right = 1cm of analytical-principle] (direct) {direct \\ method}; 
