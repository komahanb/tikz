...
\begin{tikzpicture}[scale=1.0, every node/.style={transform shape}]
  ...
  \begin{class}{Stochastic Function}
    ...
    \attribute{probabilistic space : Probabilistic Space}
    %    \operation{Add Function}
    %    \operation{Add Function State Variable Sensitivity}
    %    \operation{Add Function Design Variable Sensitivity}
  \end{class}

  \begin{class}{Probabilistic Space}
  ...
  \composition{Stochastic Function}[uses]{Probabilistic Space}
  ...
  \package{Semi-Intrusive Stochastic Galerkin Layer}{(Probabilistic Space)(Stochastic Function)(Expectation Function)(Variance Function)}
