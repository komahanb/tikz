...
\begin{tikzpicture}[scale=1.0, every node/.style={transform shape}]
  ...
  \node [block, very thick, node distance=2.5cm, text width=7.5cm, fill=white] (pde) at (0,0) {Stochastic Differential Equations};
  \node [block, very  thick, node distance=2.5cm, text width=7.5cm, fill=white, below = 1.0 cm of pde] (discretization) {Use Spatial, Temporal \& \\{Probabilistic} Discretization Methods};
  \node [block, very thick, node distance=2.5cm, text width=7.5cm, fill=white, below = 1.0 cm of discretization] (algebraic) {Stochastic Algebraic Equations};
  \node [block, very thick, node distance=2.5cm, text width=7.5cm, fill=white, below = 1.0 cm of algebraic] (evaluation) {Evaluate Residuals, Jacobian, Initial \& Boundary Conditions};

  \node [block, very thick, node distance=2.5cm, text width=7.5cm, fill=lgray!0, right = 1.0 cm of discretization, draw=dblue] (deterministic-discretization) {Use Spatial, Temporal Discretization Methods \\  (Deterministic Framework)};
  \node [block, very thick, node distance=2.5cm, text width=7.5cm, fill=lgray!0, right = 1.0 cm of algebraic, draw=dblue] (stochastic-sampling) {Use Probabilistic Sampling to Perform Galerkin Projection};

  \generalization{pde}{discretization}{}{}{}{}{}{}{}{};
  \generalization{discretization}{algebraic}
  \generalization{algebraic}{evaluation}

  \generalizationbendleft[draw=dblue]{pde}{deterministic-discretization}
  \generalization[draw=dblue]{deterministic-discretization}{stochastic-sampling}
  \generalizationbendright[draw=dblue]{stochastic-sampling}{evaluation}

%  \package{Classical Stochastic Galerkin}{(pde)(discretization)(algebraic)(evaluation)}
%  \package{}{(deterministic-discretization)(stochastic-sampling)}
