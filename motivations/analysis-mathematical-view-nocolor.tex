...
%  \node [block, very thick, node distance=3.5cm, text width=17cm, text height = 15cm, fill=white,font=\Large] (1) at (0,-5.25) {};  
  ...
  \node [block, ultra thick, 
    ...
    text width=12cm,
    fill=white!30,
    font=\Large, draw = black, below of = static-physics] (temporal-physics) {
    \begin{equation}\nonumber
      \begin{aligned}
  ...
  \node [block, ultra thick, 
    ...
    text width=6cm,
    fill=white!50,
    font=\Large, draw = black,  above = -0.65cm of temporal-physics] (temporal-physics-header) {
  ...
  \node [block, ultra thick, 
    ...
    text width=16cm,
    fill=white!30,
    font=\Large, draw = black, below of = temporal-physics] (stochastic-temporal-physics) {
    \begin{equation}\nonumber
      \begin{aligned}
  ...
  \node [block, ultra thick, 
    ...
    text width=8cm,
    fill=white!50,
    font=\Large, draw = black, above = -0.65cm of stochastic-temporal-physics] (stochastic-temporal-physics-header) {
