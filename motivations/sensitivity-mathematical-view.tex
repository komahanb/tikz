...
\begin{tikzpicture}
  ...
  \node [block, very thick, node distance=3.5cm, text width=20cm, text height = 16.5cm, fill=lgray,font=\Large] (1) at (0,0) {};  
  ...
  \node [block, very thick, 
    ...
    text width=16.5cm,
    fill=white!30,
    font=\large, below = 2cm of static-physics] (temporal-physics) {
    \begin{equation}\nonumber
      \begin{aligned}
        & \text{if}                               &  & {\cal{L}}
        %\arg{t,\xi,
  ...
  \node [block, very thick, 
    ...
    \begin{equation}\nonumber
      \begin{aligned}
        ...
        \pd{\mb{{\cal{L}}}}{{u}} - \td{}{t}  \left(\pd{{{\cal{L}}}}{{\dot{u}}} \right) + \tdt{}{t}  \left(\pd{{{\cal{L}}}}{{\ddot{u}}} \right) = 0
        & \\
        & \text{evaluate}          &  & \td{}{\xi} \mathbb{E}\left[ F \arg{t,y(\xi),u(t,y(\xi)),\dot{u}(t,y(\xi)),\ddot{u}(t,y(\xi)), \lambda\arg{t,y(\xi)} } \right]  & \\
        &                          &  & \td{}{\xi} \mathbb{V}\left[ F \arg{t,y(\xi),u(t,y(\xi)),\dot{u}(t,y(\xi)),\ddot{u}(t,y(\xi)), \lambda\arg{t,y(\xi)} } \right]  & \\
        &                          &  & \td{}{\xi} \mathbb{S}\left[ F \arg{t,y(\xi),u(t,y(\xi)),\dot{u}(t,y(\xi)),\ddot{u}(t,y(\xi)), \lambda\arg{t,y(\xi)} } \right]  & \\
      \end{aligned}
